    ...
    <Card className="col-span-2 bg-slate-800/50 border-slate-700 h-full">
      <div className="p-3 md:p-4 flex flex-col h-full">
        <div className="flex-1 relative">
          <div
            className={`absolute inset-0 bg-slate-800/80 backdrop-blur-sm z-10 flex items-center justify-center rounded-lg transition-all duration-300 ease-in-out ${isLoading ? 'opacity-100' : 'opacity-0 pointer-events-none'
              }`}
          >
